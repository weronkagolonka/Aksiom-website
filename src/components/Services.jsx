...
const Services = React.forwardRef((_props, ref) => {
    return (
        <Background>
            <Title ref={ref}>Nasza oferta</Title>
            <MainBox>
                <Section>
                ...
                <Row>
                    ...
                    <ServiceListRight>
                        <ListItem>
                            Kontrola dokumentów pod względem formalno
                            rachunkowym
                        </ListItem>
                        <ListItem>
                        ...
                        <ListItem>
                            Miesięczne lub kwartalne rozliczania podatku
                            dochodowego
                        </ListItem>
                        <ListItem>
                            Sporządzanie i dostarczanie do Urzędu Skarbowego
                ...
                <Row>
                    ...
                    <ServiceListRight>
                        ...
                        <ListItem>
                            Prowadzenie księgi głównej, pomocniczej, ewidencji
                            środków trwałych i wyposażenia oraz ewidencji dla
                            podatku VAT
                        </ListItem>
                        <ListItem>
                            Sporządzanie i dostarczanie do Urzędu Skarbowego
                        ...
                        <ListItem>
                            Sporządzanie bilansu z rachunkiem zysków i strat,
                            rachunkiem przepływów pieniężnych oraz
                        ...
                        <ListItem>
                            Na dzień rozpoczęcia działalności otwieranie ksiąg
                            handlowych wraz z utworzeniem Zakładowego Planu Kont
                        </ListItem>
                ...
                <Row>
                    ...
                    <ServiceListRight>
                        ...
                        <ListItem>
                            Wyliczanie wynagrodzeń za pracę w godzinach nocnych
                            oraz nadliczbowych
                        </ListItem>
                        <ListItem>
                        ...
                        <ListItem>
                            Naliczanie miesięcznych zaliczek na podatek
                            dochodowy pracowników, przygotowywanie przelewów do
                            Urzędu Skarbowego
                        </ListItem>
                        <ListItem>
                            Wyliczanie miesięcznych składek ZUS, sporządzanie
                            deklaracji oraz przesyłanie ich w formie
                            elektronicznej do ZUS
                        </ListItem>
                        <ListItem>
                            Przygotowywanie zgłoszeń do ubezpieczenia
                            społecznego i zdrowotnego podatników oraz
                            pracowników
                        </ListItem>
                        <ListItem>
                            Sporządzanie informacji o uzyskanych przez
                            pracowników dochodach i pobranych zaliczkach na
                            podatek dochodowy PIT-11, PIT-8B
                        </ListItem>
                        <ListItem>
                            Sporządzanie i dostarczanie do GUS sprawozdań
                            dotyczących danych kadrowych
                        </ListItem>
                    </ServiceListRight>
                </Row>
            </MainBox>
